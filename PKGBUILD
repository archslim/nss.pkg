...
source=("ftp://ftp.mozilla.org/pub/mozilla.org/security/nss/releases/NSS_${pkgver//./_}_RTM/src/${pkgbase}-${pkgver}.tar.gz"
        certdata2pem.py
        bundle.sh
        nss.pc.in
        nss-config.in
...
sha256sums=('618db0fb2af9f6fc165934d509036b65efc78ab0ae118c06c9488bb667f21d40'
            ...
            'dd02d70e64852fa8f9ac975a94eda0674a67e2ded35b35b79ab8ffb16fa2bea1')
